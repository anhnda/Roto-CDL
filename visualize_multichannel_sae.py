...
5. Obtain high-dimensional encoding activations (4096 features)
6. Select top-k most activated feature maps (e.g., top 16 out of 4096)
...
Usage:
    ...
    python visualize_multichannel_sae.py --class_name gas_pump --num_images 5 --top_k_features 16
"""
...
class MultiChannelSAEVisualizer:
    ...
    1. Extracts ResNet18 layer3 activations (256 channels, 14×14)
    2. Uses GradCAM to select top channels with 80% cumulative score
    3. Masks other channels (zeros them out)
    4. Passes masked activations through CSAE to get sparse features (4096 features)
    ...
    def _select_channels_with_gradcam(self, image: torch.Tensor) -> Tuple[torch.Tensor, int, torch.Tensor]:
        ...
        Returns:
            channel_mask: [256] - Binary mask (True for selected channels)
    ...
    def extract_features(self, image_path: str, top_k: int = 16) -> Dict:
        ...
        4. Pass through CSAE to get sparse features (4096 features)
        ...
        Returns:
            results: Dictionary containing:
                ...
                - layer3_masked: Masked activations [1, 256, 14, 14]
                - num_selected_channels: Number of channels selected by GradCAM
                - channel_mask: Binary mask [256] for selected channels
                - channel_weights: GradCAM weights [256]
        ...
        layer3_masked = layer3_acts * mask_4d  # [1, 256, 14, 14]
    ...
    def _plot_feature_grid(self, image: Image.Image, top_features: List[Tuple],
        ...
        info_text += f"  • Selected: {num_selected_channels}/256 channels\n"
        ...
        plt.suptitle(f'Multi-Channel ConvSAE: Top-{n_features} Activated Features (14×14 Heatmaps)\n' +
                    f'GradCAM: {num_selected_channels} channels selected → CSAE: 4096 features → Top-{n_features} visualized',
