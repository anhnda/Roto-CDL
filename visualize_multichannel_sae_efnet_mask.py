...
Usage:
    ...
    python visualize_multichannel_sae_efnet_mask.py --image_path data/imagenette/tench/n01440764_1.JPEG

    # Visualize multiple images from a class
    python visualize_multichannel_sae_efnet_mask.py --class_name tench --num_images 3

    # Customize parameters
    python visualize_multichannel_sae_efnet_mask.py --class_name gas_pump --num_images 5 --top_k_features 16
"""
