...
Usage:
    ...
    # CONSISTENCY MODE: Analyze 10 classes with 3 images each (DEFAULT: 3 images per class)
    python visualize_testmf_resnet.py --num_classes 10 --top_k_features 12

    # CONSISTENCY MODE: Custom number of images per class
    python visualize_testmf_resnet.py --num_classes 5 --images_per_class_viz 3 --top_k_features 16
    ...
    python visualize_testmf_resnet.py --force_resample --test_images_per_class 10 --num_classes 5
...
class MultiChannelSAEVisualizerTestMF:
    ...
    def _plot_class_consistency(self, all_results: List[Dict], label: int,
        ...
        # Title
        plt.suptitle(f'Feature Consistency Analysis: Class {label} ({class_name[:40]}...)\n' +
...
def main():
    ...
    if args.num_classes is not None:
        ...
        for class_idx, images in class_samples.items():
            ...
            save_path = output_dir / f"class_{class_idx}_consistency.png"
